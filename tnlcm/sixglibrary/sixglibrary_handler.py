...
class SixGLibraryHandler:
    ...
    def extract_parts_components_6glibrary(self):
        ...
        if not os.path.exists(self.git_6glibrary_local_directory) or not os.path.exists(os.path.join(self.git_6glibrary_local_directory, ".git")):
            ...
            output_part = self.extract_output_part_component_6glibrary(components)
    ...
    def extract_components_6glibrary(self):
        ...
        if not os.path.exists(self.git_6glibrary_local_directory) or not os.path.exists(os.path.join(self.git_6glibrary_local_directory, ".git")):
            ...
            return [folder for folder in os.listdir(self.git_6glibrary_local_directory)
                if os.path.isdir(os.path.join(self.git_6glibrary_local_directory, folder))
                and folder not in SIXGLIBRARY_EXCLUDE_FOLDERS]