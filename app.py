...
from core.routes import callback_namespace, debug_namespace, jenkins_namespace, sixg_library_namespace, sixg_sandbox_sites_namespace, trial_network_namespace, user_namespace, verification_token_namespace
