...
class TempFileHandler:
    ...
    def add_private_entity_parameters(self, entity_data, tn_descriptor, report_directory, tn_id):
        ...
        if entity_type == "tn_bastion":
            ...
            entity_public["external_vnet_id"] = self.find_vxlan_id(entity_public["external_vnet_id"], tn_descriptor, report_directory, tn_id)
            entity_public["internal_vnet_id"] = self.find_vxlan_id(entity_public["internal_vnet_id"], tn_descriptor, report_directory, tn_id)
