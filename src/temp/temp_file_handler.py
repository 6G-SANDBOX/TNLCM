...
class TempFileHandler:
    ...
    def add_private_entity_parameters(self, entity_data, descriptor_trial_network, report_directory, tn_id):
    ...
    def create_entity_temp_file(self, entity_data, descriptor_trial_network, report_directory, tn_id):
        ...
        with NamedTemporaryFile(delete=False, dir=TEMP_FILES_PATH, suffix=".yaml", mode='w') as entity_temp_file:
            entity_public = self.add_private_entity_parameters(entity_data, descriptor_trial_network, report_directory, tn_id)
