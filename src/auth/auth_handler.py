...
class AuthHandler:
    ...
    def __init__(self, mongo_handler=None, jwt_identity=None, username=None, email=None, password=None, org=None):
        """Constructor"""
    ...
    def get_current_user_from_jwt(self):
        ...
        log_handler.info("Get the user that is associated with the token")
        query = {"username": self.jwt_identity}
        user = self.mongo_handler.find_data(collection_name="users", query=query)
        return user
    ...
    def get_username(self):
        ...
        user = self.mongo_handler.find_data(collection_name="users", query=query, projection=projection)
        return user
    ...
    def get_email(self):
        ...
        email = self.mongo_handler.find_data(collection_name="users", query=query, projection=projection)
        return email
    ...
    def _get_password(self):
        ...
        password = self.mongo_handler.find_data(collection_name="users", query=query, projection=projection)
        return password
    ...
    def add_user(self):
        ...
        self.mongo_handler.insert_data("users", user_doc)
    ...
    def update_password(self):
        ...
        self.mongo_handler.update_data(collection_name="users", query=query, projection=projection)
