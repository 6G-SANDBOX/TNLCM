...
class CreateTrialNetwork(Resource):
    ...
    def post(self) -> tuple[dict, int]:
        ...
        try:
            ...
            trial_network.set_directory_path(directory_path)
            log_handler.info(f"[{trial_network.tn_id}] - Create the folder '{trial_network.tn_id}' in the path '{trial_network.directory_path}' to store the directories and files generated by the trial network")
            trial_network.set_raw_descriptor(tn_descriptor_file)
