    ...
    def put(self, tn_id: str) -> tuple[dict, int]:
        ...
        try:
            ...
            if tn_state == "validated":
                ...
                log_handler.info(f"[{trial_network.tn_id}] - Validate pipeline use for deploy trial network '{jenkins_deploy_pipeline}'")
                ...
                trial_network.save()
                log_handler.info(f"[{trial_network.tn_id}] - Pipeline for deploy trial network '{trial_network.jenkins_deploy_pipeline}' is valid")
