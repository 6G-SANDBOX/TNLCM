...
class CreateTrialNetwork(Resource):
    ...
    def post(self) -> tuple[dict, int]:
        ...
        try:
            ...
            sites_handler = SitesHandler(https_url=sites_https_url, reference_type="branch", reference_value=deployment_site, directory_path=trial_network.directory_path)
