...
class UpdateCommitSixGLibrary(Resource):
    ...
    def post(self) -> tuple[dict, int]:
        ...
        try:
            ...
            sixg_library_handler = SixGLibraryHandler(reference_type="commit", reference_value=trial_network.github_6g_library_commit_id, tn_directory_path=trial_network.tn_directory_path)
...
class UpdateCommitSixGSandboxSites(Resource):
    ...
    def post(self) -> tuple[dict, int]:
        ...
        try:
            ...
            sixg_sandbox_sites_handler = SixGSandboxSitesHandler(reference_type="commit", reference_value=trial_network.github_6g_library_commit_id, tn_directory_path=trial_network.tn_directory_path)
...
class DeleteDebugEntityName(Resource):
    ...
    def post(self) -> tuple[dict, int]:
        ...
        try:
            ...
            tn_sorted_descriptor = trial_network.tn_sorted_descriptor["trial_network"]
            tn_deployed_descriptor = trial_network.tn_deployed_descriptor["trial_network"]
            del tn_raw_descriptor[entity_name]["debug"]
            del tn_sorted_descriptor[entity_name]["debug"]
            del tn_deployed_descriptor[entity_name]["debug"]
