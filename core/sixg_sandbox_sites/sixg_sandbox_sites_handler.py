...
class SixGSandboxSitesHandler():
    ...
    def __init__(
        ...
        :param tn_directory_path: directory path into which the 6G-Sandbox-Sites is to be cloned, ``str``
        """
        ...
        self.github_6g_sandbox_sites_local_directory = os.path.join(tn_directory_path, self.github_6g_sandbox_sites_repository_name)
